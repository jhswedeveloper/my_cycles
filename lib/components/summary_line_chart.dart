...
/// Show monthly statistics over
/// (1) Mood levels
/// (2) Energy levels
class SummaryLineChart extends StatefulWidget {
  @override
  _SummaryLineChartState createState() => _SummaryLineChartState();
}
      ...
      titlesData: FlTitlesData(
        bottomTitles: SideTitles(
          ...
          getTitles: (value) {
            ...
            switch (value.toInt()) {
              case 2:
                return formatter.format(DateTime(now.year, now.month - 2, now.day));
              case 7:
                return formatter.format(DateTime(now.year, now.month - 1, now.day));
              case 12:
                return formatter.format(DateTime(now.year, now.month, now.day));
            }
            return '';
          },
        ),
